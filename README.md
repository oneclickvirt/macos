...
If you need to edit and modify it by yourself, after you fork this repository, you need to set the IP and PASSWORD in the settings of the repository, or create a project in appveyor to track the repository after you fork it, and then add the IP and PASSWORD in the settings of the project, and then the image will be automatically uploaded to the /root/macos folder of the server with the corresponding IP after you execute the task. After the task is executed, the image will be automatically uploaded to the /root/macos folder of the server with the corresponding IP. 
